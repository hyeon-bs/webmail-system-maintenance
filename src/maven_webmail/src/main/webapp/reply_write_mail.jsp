<%-- 
    Document   : reply_write_mail
    Created on : 2019. 5. 30., 오후 9:53:15
    Author     : jiwon
--%>
                ...
                <table>
                    <tr>
                        ...
                        <td> <input type="text" name="to" size="80"
                                    value="<%=request.getParameter("recv_addr") == null ? "" : request.getParameter("recv_addr")%>"> </td>
                    </tr>
                    <tr>
                        <td>참조</td>
                    ...
                    <tr>
                        <td>발송예약<input type="checkbox"></td>
                        <td> <input type="text" name="cc" size="80">  </td>
                    </tr>  
                    <tr>
                        <td> 메일 제목 </td>
