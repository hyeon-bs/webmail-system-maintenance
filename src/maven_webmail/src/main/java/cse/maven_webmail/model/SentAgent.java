...
public class SentAgent {
    ...
    public SentAgent(String host, String userid, String password) {
        this.host = host;
        this.userid = userid;
...
//            Folder folder = store.getDefaultFolder();
    ...
    public String getMessageList() {
        ...
        for (int i = 0; i < messages.length; i++) {
            ...
            if (!messages[i].isSet(Flags.Flag.SEEN)) printMessage(messages[i], 0);
        ...
        store.close();*/
            ...
            SentMessageFormatter formatter = new SentMessageFormatter(userid);  //3.5
    ...
    public String getMessage(int n) {
        ...
        try {
            ...
            SentMessageFormatter formatter = new SentMessageFormatter(userid);
