...
* **Database**: MySQL
* **Server & Environment**: Apache Tomcat 9, Apache James 2.3.2
* **Tools**: SmartGit, SonarQube
...
#### 
**2. 관리자 계정 생성 과정의 보안 문제**
* 관리자 권한으로 사용자를 추가할 때 아이디와 비밀번호만 입력하면 바로 계정이 생성되는 구조였습니다.
...
#### 
**4. 레거시 코드 구조의 한계**
* 기존 프로젝트 구조에서 중복 코드와 유지보수성이 떨어지는 표현들이 존재했습니다.
